    ...
    <main className="min-h-screen bg-stone-50 text-slate-900">
      ...
      <section id="informacion" className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mt-4 leading-7 text-slate-700">
          No todos los casos pueden tramitarse del mismo modo. Por eso es esencial
          estudiar la permanencia en España, la documentación disponible y el
          encaje real de cada situación antes de iniciar cualquier actuación.
        </p>
        ...
        <p className="mt-4 leading-7 text-slate-700">
          Reviso la documentación, valoro riesgos y defino una estrategia jurídica
          realista para ayudarte a tomar decisiones informadas y reducir errores
          evitables.
        </p>
      </section>
      ...
      >
        <svg
          ...
          className="h-6 w-6"
        >
          <path d="M12 2a10 10 0 0 0-8.66 15l-1.1 4.02 4.12-1.08A10 10 0 1 0 12 2Zm0 18a8 8 0 0 1-4.07-1.11l-.29-.17-2.44.64.65-2.38-.19-.3A8 8 0 1 1 12 20Zm4.38-5.03c-.24-.12-1.43-.7-1.65-.78-.22-.08-.38-.12-.55.12-.16.24-.63.78-.77.94-.14.16-.28.18-.52.06-.24-.12-1.01-.37-1.92-1.17-.71-.63-1.2-1.41-1.34-1.65-.14-.24-.01-.37-.19-.49.1-.1.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.30-.02-.42-.06-.12-.55-1.33-.75-1.82-.2-.48-.4-.42-.55-.43h-.47c-.16 0-.42.06-.64.3-.22.24-.84.82-.84 2s.86 2.31.98 2.47c.12.16 1.68 2.56 4.07 3.59.57.25 1.02.39 1.37.5.58.18 1.1.15 1.52.09.46-.07 1.43-.58 1.63-1.14.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28Z" />
        </svg>
      </a>
    </main>
  );
