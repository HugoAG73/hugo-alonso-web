    ...
    <main className="min-h-screen bg-stone-50 text-slate-900">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:py-28">
          <div>
            <div className="inline-flex rounded-full border border-stone-300 bg-white px-4 py-2 text-xs font-medium uppercase tracking-[0.25em] text-slate-600 shadow-sm">
              Abogado de extranjería · Regularización masiva en España
            </div>

            <h1 className="mt-8 max-w-4xl text-4xl font-semibold tracking-tight text-slate-950 lg:text-6xl">
              ¿Puedes acceder a la regularización masiva en España?
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-700">
              Analizo tu caso y te indico, con criterio jurídico, si puedes
              iniciar el proceso de regularización masiva y cómo hacerlo
              correctamente.
            </p>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
              Asesoramiento jurídico individualizado en materia de extranjería.
            </p>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <a
                href="https://wa.me/34686310400?text=Hola,%20soy%20Hugo%20Alonso,%20abogado.%20%C2%BFC%C3%B3mo%20puedo%20ayudarte%3F"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <aside className="self-start rounded-[2rem] border border-stone-200 bg-white p-8 shadow-xl shadow-stone-200/60">
      ...
      >
        <svg
          ...
          className="h-6 w-6"
        >
          <path d="M12 2a10 10 0 0 0-8.66 15l-1.1 4.02 4.12-1.08A10 10 0 1 0 12 2Zm0 18a8 8 0 0 1-4.07-1.11l-.29-.17-2.44.64.65-2.38-.19-.3A8 8 0 1 1 12 20Zm4.38-5.03c-.24-.12-1.43-.7-1.65-.78-.22-.08-.38-.12-.55.12-.16.24-.63.78-.77.94-.14.16-.28.18-.52.06-.24-.12-1.01-.37-1.92-1.17-.71-.63-1.2-1.41-1.34-1.65-.14-.24-.01-.37.1-.49.1-.1.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.55-1.33-.75-1.82-.2-.48-.4-.42-.55-.43h-.47c-.16 0-.42.06-.64.3-.22.24-.84.82-.84 2s.86 2.31.98 2.47c.12.16 1.68 2.56 4.07 3.59.57.25 1.02.39 1.37.5.58.18 1.1.15 1.52.09.46-.07 1.43-.58 1.63-1.14.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28Z" />
        </svg>
      </a>
    </main>
  );
