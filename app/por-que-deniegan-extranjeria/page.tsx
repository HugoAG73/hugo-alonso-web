    ...
    <main className="min-h-screen bg-stone-50 text-slate-900">
      ...
      <section className="mx-auto max-w-3xl px-6 py-20">
        ...
        <p className="mt-4 text-base leading-7 text-slate-700">
          Entender por qué se produce una denegación es importante, no solo para conocer qué ha fallado, sino también para determinar si existen opciones para recurrir o si la situación puede corregirse en un nuevo procedimiento.
        </p>
        ...
        <div className="mt-12 flex flex-col gap-4 sm:flex-row">
          ...
          >
            Ir a denegación de extranjería
          </Link>
        </div>
      </section>
    </main>
